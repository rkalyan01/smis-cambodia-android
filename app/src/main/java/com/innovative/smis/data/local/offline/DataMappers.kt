...
fun BuildingSurveyEntity.toBuildingSurvey(): BuildingSurvey {
    return BuildingSurvey(
        ...
        structureTypeId = this.structureType,
        functionalUseId = this.functionalUse,
        buildingUseId = this.buildingUse,
        numberOfFloors = this.floorCount.toIntOrNull(),
        householdServed = this.householdServed.toIntOrNull(),
        populationServed = this.populationServed.toIntOrNull(),
        isMainBuilding = this.isMainBuilding == "yes",
        floorArea = 0.0, // this.floorArea not in Entity? Adding default
        constructionYear = 0, // this.constructionDate parsing? Adding default
        waterSupply = this.waterConnection,
        defecationPlaceId = this.placeOfDefecation,
        numberOfToilets = this.numberOfToilets,
        toiletConnectionId = this.toiletConnection,
...
fun BuildingSurvey.toEntity(): BuildingSurveyEntity {
    return BuildingSurveyEntity(
        ...
        respondentContact = this.respondentContact ?: "",
        ownerName = this.ownerName ?: "",
        // ownerNameKhmer, ownerGender not in Domain
        ownerContact = this.ownerContact ?: "",
        structureType = this.structureTypeId ?: "",
        floorCount = (this.numberOfFloors ?: 0).toString(),
        householdServed = (this.householdServed ?: 0).toString(),
        populationServed = (this.populationServed ?: 0).toString(),
        isMainBuilding = if (this.isMainBuilding == true) "yes" else "no",
        buildingPhoto = "",
        functionalUse = this.functionalUseId ?: "",
        buildingUse = this.buildingUseId ?: "",
        officeName = "",
        constructionDate = this.constructionDate ?: "",
        presenceOfToilet = if ((this.numberOfToilets ?: 0) > 0) "yes" else "no",
        placeOfDefecation = this.defecationPlaceId ?: "",
        placeOfDefecationOther = "",
        sharedToiletBin = "",
        toiletConnection = this.toiletConnectionId ?: "",
        toiletConnectionOther = "",
        sharedConnectionBin = "",
        drainCode = "",
        sewerCode = "",
        sewerBill = "",
        ...
        pitDiameter = "",
        pitDepth = "",
        storageTankType = this.typeOfStorageTank ?: "",
        storageTankTypeOther = "",
        storageTankOutlet = "",
        storageTankOutletOther = "",
        storageTankSize = (this.sizeOfTank ?: 0.0).toString(),
        storageTankYear = "",
        storageTankAccessible = this.accessToContainment ?: "",
        storageTankEmptied = "",
        storageTankLastEmptied = this.lastEmptiedDate ?: "",
        waterConnection = this.waterSupply ?: "",
        waterCustomerId = this.waterCustomerId ?: "",
        waterMeterNumber = this.meterSerialNumber ?: "",
        waterMeterPhoto = "",
        waterBillPhoto = "",
        waterShared = "",
        waterSharedBin = "",
        distanceHouseToContainment = this.distanceHouseToContainment ?: "",
        vacutugAccessible = this.vacutugAccessible ?: false,
        lastEmptiedDate = this.lastEmptiedDate ?: "",
        distanceFromWell = this.distanceFromWell ?: "",
        numberOfTanks = this.numberOfTanks ?: 0,
        sizeOfTank = this.sizeOfTank ?: 0.0,
        typeOfStorageTank = this.typeOfStorageTank ?: "",
        storageTankConnection = this.storageTankConnection ?: "",
        toiletCount = this.toiletCount ?: 0,
        numberOfToilets = this.numberOfToilets ?: 0,
        sanitationSystem = this.sanitationSystem ?: "",
        technology = this.technology ?: "",
        compliance = this.compliance ?: "",
        comments = this.comments ?: "",
