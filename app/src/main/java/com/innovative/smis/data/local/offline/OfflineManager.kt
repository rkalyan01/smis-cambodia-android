    ...
    suspend fun saveBuildingSurveyOffline(bin: String, request: BuildingSurveyRequest): Flow<Resource<BuildingSurveyResponse>> = flow {
        ...
        try {
            ...
            val surveyEntity = BuildingSurveyEntity(
                ...
                // ownerNameKhmer and ownerGender not in request, using defaults
                ownerContact = request.ownerContact ?: "",
                structureType = request.structureTypeId ?: "", // Map ID to string?
                floorCount = (request.numberOfFloors ?: 0).toString(), // Map Int to String
                householdServed = (request.householdServed ?: 0).toString(), // Map Int to String
                populationServed = (request.populationServed ?: 0).toString(), // Map Int to String
                isMainBuilding = if (request.isMainBuilding == true) "yes" else "no",
                buildingPhoto = "", // Missing in request?
                functionalUse = request.functionalUseId ?: "",
                buildingUse = request.buildingUseId ?: "",
                officeName = "", // Missing in request
                constructionDate = request.constructionDate ?: "",
                presenceOfToilet = if ((request.numberOfToilets ?: 0) > 0) "yes" else "no", // Infer?
                placeOfDefecation = request.defecationPlaceId ?: "",
                placeOfDefecationOther = "",
                sharedToiletBin = "",
                toiletConnection = request.toiletConnectionId ?: "",
                ...
                pitDiameter = "",
                pitDepth = "",
                storageTankType = request.typeOfStorageTank ?: "",
                storageTankTypeOther = "",
                storageTankOutlet = "",
                storageTankOutletOther = "",
                storageTankSize = (request.sizeOfTank ?: 0.0).toString(),
                storageTankYear = "",
                storageTankAccessible = request.accessToContainment ?: "",
                storageTankEmptied = "",
                storageTankLastEmptied = request.lastEmptiedDate ?: "",
                waterConnection = request.waterSupply ?: "",
                waterCustomerId = request.waterCustomerId ?: "",
                waterMeterNumber = request.meterSerialNumber ?: "",
                waterMeterPhoto = "",
                waterBillPhoto = "",
                waterShared = "",
                waterSharedBin = "",
                distanceHouseToContainment = request.distanceHouseToContainment ?: "",
                vacutugAccessible = request.vacutugAccessible ?: false,
                lastEmptiedDate = request.lastEmptiedDate ?: "",
                distanceFromWell = request.distanceFromWell ?: "",
                numberOfTanks = request.numberOfTanks ?: 0,
                sizeOfTank = request.sizeOfTank ?: 0.0,
                typeOfStorageTank = request.typeOfStorageTank ?: "",
                storageTankConnection = request.storageTankConnection ?: "",
                toiletCount = request.toiletCount ?: 0,
                numberOfToilets = request.numberOfToilets ?: 0,
